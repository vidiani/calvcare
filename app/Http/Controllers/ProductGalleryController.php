    ...
    public function index(Product $product)
    {
        if (request()->ajax()) {
            ...
            ->addColumn('action', function ($item) {
                ...
                <button class="border border-red-500 bg-red-500 text-white rounded-md px-2 py-1 m-2 transition duration-500 ease select-none hover:red-600 focus:outline-none focus:shadow-outline">
                Hapus
                </button>
